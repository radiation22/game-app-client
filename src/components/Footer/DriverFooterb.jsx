              ...
              {isActive ? (
                <>
                  <div className="flex flex-col items-center">
                    ...
                    <span className="uppercase pt-1 text-sm text-[#04A83F]"></span>
                  </div>
                </>
              ) : (
                <>
